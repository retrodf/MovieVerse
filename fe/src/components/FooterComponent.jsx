      ...
      <Container>
        <Row className="d-flex justify-content-between align-items-start">
          <Col lg="3">
            ...
            <p className="desc">
              Lorem ipsum dolor sit, amet consectetur adipisicing elit. Ipsum esse deserunt nesciunt, quod qui dignissimos officia earum alias cum vitae.
            </p>
            <div className="no mb-1 mt-4 text-white">
              <Link className="text-decoration-none">
                <i className="fa-brands fa-whatsapp"></i>
                <p className="m-0 text-white">+62 812-2164-5542</p>
              </Link>
            </div>
            <div className="mail">
              <Link className="text-decoration-none">
                <i className="fa-regular fa-envelope"></i>
                <p className="m-0 text-white">movieverse@gmail.com</p>
              </Link>
            </div>
          </Col>
          <Col lg="2" className="d-flex flex-column mt-lg-0 mt-5">
